        ...
        <div className="loginBox">
          <div className='login-space'>
            ...
            <form className='pb-5 pt-4'>
              ...
              <div className='loginBox-inputSpace items-center space-x-3'>
                <FontAwesomeIcon icon={faUser}/>
                <input className="pl-1" placeholder="Name@mail.kmutt.ac.th"/>
              </div>
          ...
          <div className='web-introduce-space'>
              ...
              <label className='text-left web-intro'><span className='hightlight-blue'>Seaa itt</span> stands for Search Engine and Artificial Intelligence Tags Tracker which work in collecting the CPE project documents in the form of website for searching. This will collect projects for the Computer Engineering Department, Faculty of Engineering, Kingmongkut’s University of Technology Thonburi in the past year.</label>
          </div>
        </div>
